...
本模块定义 3 个核心 Agent 的系统提示词
这是 Agent 行为的核心，决定了 Agent 如何理解和执行任务

核心提示词：
1. todo_planner_system_prompt - TODO 规划 Agent 的系统提示词
2. task_summarizer_instructions - 任务总结 Agent 的系统提示词
3. report_writer_instructions - 报告撰写 Agent 的系统提示词

提示词工程要点：
- 明确 Agent 的角色和职责
- 提供清晰的目标和要求
- 定义输出格式（JSON/Markdown）
- 说明工具调用方式
- 提供示例和模板
...
def get_current_date():
    ...
    Returns:
        str: 格式化的日期字符串（如 "February 28, 2026"）
    """
...
# =============================================================================
# Agent 1: TODO 规划 Agent 的系统提示词
# 这个 Agent 负责将研究主题分解为具体的 TODO 任务列表
# =============================================================================
...
# =============================================================================
# Agent 2: 任务总结 Agent 的系统提示词
# 这个 Agent 负责总结每个 TODO 任务的搜索结果
# =============================================================================
...
# =============================================================================
# Agent 3: 报告撰写 Agent 的系统提示词
# 这个 Agent 负责整合所有任务总结，生成最终的研究报告
# =============================================================================
